...
print('mapping tissue count')
mapSym(paste0(dirname, '/tissue_count.csv'), paste0(dirname, '/tissue_count'))
...
print('mapping sample fpkm')
mapSym(paste0(dirname, '/sample_count.csv'), paste0(dirname, '/sample_count'))
